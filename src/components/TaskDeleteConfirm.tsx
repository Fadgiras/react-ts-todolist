...
export default class TaskDeleteConfirm extends Component<TaskProps, any>{
    ...
    deleteTask = () => {
        new StorageService().deleteTask(this.props.task)
    ...
    render(): React.ReactNode {
        return <div>
            ...
            <div className="fixed bottom-0 top-0 left-0 right-0 m-auto flex w-1/2 bg-gray-400 text-black h-fit rounded shadow-lg shadow-blue-800 flex flex-col items-center">
